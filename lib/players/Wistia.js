...
var Wistia = function (_Base) {
  ...
  _createClass(Wistia, [{
    ...
    key: 'getWistiaConfig',
    value: function getWistiaConfig() {
      var wistiaConfig = this.props.wistiaConfig;

      return Object.assign({}, _props2.defaultProps.wistiaConfig, wistiaConfig);
    }
  }, {
    key: 'getPlayerColor',
    value: function getPlayerColor() {
      var wistiaConfig = this.getWistiaConfig();
    ...
    key: 'getPopoverAnimate',
    value: function getPopoverAnimate() {
      var wistiaConfig = this.props.wistiaConfig;
    ...
    value: function render() {
      ...
      var popoverAnimateThumbnail = this.getPopoverAnimate();
      var className = 'wistia_embed wistia_async_' + id + ' ' + playerColor + ' ' + popover + ' ' + popoverAnimateThumbnail;
